...
=head2 failed
    ...
    my $tried = $app->tried("Some::Module");
    $app->tried("Some::Module", 1);
    my @tried = $app->tried;
...
given module has been tried; with two, both set the status of the given
module. With no arguments they return a sorted list of all modules tried
or failed.
